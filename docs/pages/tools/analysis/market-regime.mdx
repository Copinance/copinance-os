...
copinance ask "What is the current market trend and volatility regime?" --instrument AAPL

# Analyze market cycles
copinance ask "What market cycle phase is this instrument in?" --instrument TSLA

# Comprehensive regime analysis
copinance ask "Analyze the market regime for this instrument including trend, volatility, and cycle phases" --instrument MSFT
```
...
copinance ask "Analyze this instrument's regime and compare it to the broader market conditions including VIX and sector rotation" --instrument AAPL
```
