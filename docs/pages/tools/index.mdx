...
Copinance OS provides a comprehensive suite of tools for market research and analysis. Tools are executable functions that can be used in workflows, especially agent workflows where AI agents can dynamically select and use tools to answer questions.
...
```bash
copinance ask "What is the current market trend?" --instrument AAPL
```
